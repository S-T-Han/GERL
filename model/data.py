...
class MIND_small():
    def __init__(self):
        self.data_path = '/home/sthan/Codefield/python/GERL' + '/data/'
        self.behaviors_path = {'train': 'train_small/behaviors.tsv', 'dev': 'dev_small/behaviors.tsv'}
        self.news_path = {'train': 'train_small/news.tsv', 'dev': 'dev_small/news.tsv'}
        self.user_id_vocab_path = 'dgl_small/vocab/user_id_vocab.json'
        self.news_id_vocab_path = 'dgl_small/vocab/news_id_vocab.json'
